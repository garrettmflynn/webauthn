...
import * as packed     from './packed.js'
...
let verifyAuthenticatorAttestationResponse = (webAuthnResponse) => {
    ...
    if(ctapMakeCredResp.fmt === 'fido-u2f') {
        ...
        authrDataStruct = parseMakeCredAuthData(ctapMakeCredResp.authData);
        ...
        authrDataStruct = packed.parseAuthData(ctapMakeCredResp.authData);
...
let verifyAuthenticatorAssertionResponse = (webAuthnResponse, authenticators) => {
    ...
    if (authr.fmt === 'fido-u2f') {
        ...
        authrDataStruct  = parseGetAssertAuthData(authenticatorData);
        ...
        authrDataStruct  = packed.parseAuthData(authenticatorData);
        response.verified = true
    }

    if(response.verified) {

        // TODO: This will never throw...
